...
<script type="application/javascript">
 ...
 var param;
  function showDetail(evt){
    var pid=evt;
    if( pid!==null ){
      window.location.href="paymentdetail?pid="+pid+"&t="+CCSKEY();
      return;
    }
